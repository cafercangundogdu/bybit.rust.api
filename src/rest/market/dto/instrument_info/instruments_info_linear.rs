...
#[derive(Debug, Serialize, Deserialize)]
pub struct InstrumentsInfoLinearResponse(ServerResponse<InstrumentsInfoLinearResult>);

impl InstrumentsInfoLinearResponse {
    pub fn into_inner(self) -> InstrumentsInfoLinearResult {
        self.0.result
    }

    pub fn into_response(self) -> ServerResponse<InstrumentsInfoLinearResult> {
        self.0
    }
}
